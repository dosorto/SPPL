...
<head>
    ...
    <title>JADEH - Plan Premium</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="container mx-auto p-8 bg-white rounded-lg shadow-xl max-w-2xl mt-24">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-extrabold text-blue-800 mb-2">Plan Premium</h1>
                <p class="text-lg text-gray-600">Soluciones completas para grandes corporaciones.</p>
            </div>
            
            <form action="{{ route('membresia.solicitud') }}" method="POST" class="space-y-6">
                @csrf
                <input type="hidden" name="plan_name" value="Plan Premium">
                <div>
