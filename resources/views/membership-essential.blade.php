...
<head>
    ...
    <title>JADEH - Plan Esencial</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="container mx-auto p-8 bg-white rounded-lg shadow-xl max-w-2xl mt-24">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-extrabold text-green-600 mb-2">Plan Esencial</h1>
                <p class="text-lg text-gray-600">Ideal para plantas que inician la digitalización.</p>
            </div>
            
            <form action="{{ route('membresia.solicitud') }}" method="POST" class="space-y-6">
                @csrf
                <input type="hidden" name="plan_name" value="Plan Esencial">
                <div>
                ...
                <div class="text-center">
                    <button type="submit"
                            class="w-full sm:w-auto px-6 py-3 bg-green-500 text-white font-semibold rounded-full hover:bg-green-600 transition-all shadow-lg text-lg">
                        Solicitar este Plan
                    </button>
                </div>
            </form>
