...
class CajaAperturaPolicy
{
    ...
    {
        return $user->can('view_any_caja_aperturas');
    }
    ...
    {
        return $user->can('view_caja_aperturas');
    }
    ...
    {
        return $user->can('create_caja_aperturas');
    }
    ...
    {
        return $user->can('update_caja_aperturas');
    }
    ...
    {
        return $user->can('delete_caja_aperturas');
    }
    ...
    {
        return $user->can('restore_caja_aperturas');
    }
    ...
    {
        return $user->can('force_delete_caja_aperturas');
    }
}
