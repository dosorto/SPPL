...
use App\Filament\Resources\OrdenesProduccionResource\RelationManagers;
...
class OrdenesProduccionResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListOrdenesProduccions::route('/'),
            'create' => Pages\CreateOrdenesProduccion::route('/create'),
            'edit' => Pages\EditOrdenesProduccion::route('/{record}/edit'),
            'view' => Pages\ViewOrdenesProduccion::route('/{record}'),
        ];
    }
}
